...
CLASSIFY_TOOL = {
    ...
    "input_schema": {
        ...
        "properties": {
            ...
            "interview_datetime": {"type": "string", "description": "If (and only if) the email schedules an interview or call at a SPECIFIC date AND time, that moment as US-Pacific ISO 8601 (e.g. 2026-07-02T14:30:00). Empty string if no specific time is given."},
        },
...
_SYSTEM = (
    ...
    "interview_datetime to that moment in US-Pacific ISO 8601 (date and time together); "
